...
const ProjectCard = ({
    ...
    return (
        <div className="bg-[#101130] rounded-lg shadow-lg p-6 w-full w-full m-2">
            ...
            <h3 className="text-xl font-bold mt-4 text-[#f0f8ff] text-center sm:text-left">
                {name}
            </h3>
            <div className="flex flex-wrap mt-2 justify-center sm:justify-start">
                {techStacks.map((tech, index) => (
                    <span
                        key={index}
                        className="bg-[#28283c] text-[#f0f8ff] rounded-full px-2 py-1 text-sm mr-2 mt-2"
                    >
                        {tech}
                    </span>
                ))}
            ...
            <div className="flex justify-center sm:justify-start mt-4">
                <button
                    onClick={openModal}
                    className="bg-[#b54ed7] hover:bg-blue-700 text-[#28283c] font-bold py-2 px-4 rounded"
                >
                    Preview
                </button>
            </div>
